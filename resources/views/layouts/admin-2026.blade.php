...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
  <div class="container-fluid">
    <a class="navbar-brand" href="{{  url('/') }}">
      {{-- <img src="http://kat-wind.com/wp/wp-content/uploads/2018/03/header_logo.png" alt="神戸学園都市吹奏楽団"> --}}
      Kat-WO
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link" href="{{ action('Admin\HomeController@index') }}">活動予定一覧</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="{{ action('Admin\HomeController@create') }}">活動予定を新規登録</a>
        </li>
      </ul>
      <ul class="navbar-nav mb-2 mb-lg-0">
        <!-- テーマ切替ドロップダウン（右寄せの左側） -->
